...
(() => {
  ...
  const passwordInputElements = [
    document.querySelector('body > div.container > div.auth > div.form.create_vault > div.input_container:nth-child(3) > input'),
    document.querySelector('body > div.container > div.auth > div.form.create_vault > input:nth-child(2)'),
  ];
