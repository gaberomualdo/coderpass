...
const enterVaultBtnElement = document.querySelector(
...
document
  .querySelector('body > div.container > div.auth > div.form.enter_vault > div.input_container:nth-child(2) > input:first-child')
